            ...
            <div className='border-none'>
                ...
                <div className='intro text-center p-10 text-white bg-[#8A93CC] w-full leading-loose'>
                    <div>
                        ...
                        <p>비전공자로 시작했지만 프론트엔드 개발에 매료되어 꾸준히 배우고 경험을 쌓아왔으며, </p>
                        <p>디자인 전공에서 얻은 감각을 바탕으로 사용자 경험을 고려한 UI를 구현하는 개발자로 성장하고 있습니다.</p>
                        <p className='font-semibold'>앞으로도 더 나은 사용자 경험과 코드를 고민하며 꾸준히 성장하는 개발자가 되겠습니다.</p>
                    </div>
                </div>
            </div>
        </section>
