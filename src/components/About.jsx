...
function About() {
    ...
    return(
        <section className='content w-full '>
            <div className=''>
            <section className='profile flex gap-28 max-w-[1280px] mx-auto px-4 p-10'>
                ...
                <div className='pt-4'>
                    ...
                    <p className='text-2xl mb-10'>계원예술대학교 화훼디자인과</p>

                    <div className='text-xl'>
                        <Link to="" className={`mr-5 ${buttonClass}`} target="_blank">Git hub</Link>
                        <Link to="" className={buttonClass} target="_blank">이력서 바로가기</Link>
                    </div>
                </div>
            </section>
